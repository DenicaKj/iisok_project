...
@section('content')
    <div class="container">
        <h1 class="text-center mb-5">News Articles</h1>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card position-relative">
                            <div class="card-body">
                                ...
                                <a href="{{ route('details', $article->id) }}" class="btn btn-secondary">Details</a>

                            @auth
                                    <div class="float-right">
                                        <!-- Like Button -->
                                        <form action="{{ route('like', $article->id) }}" method="POST" class="d-inline">
                                            @csrf
                                        ...
                                        <!-- Bookmark Button -->
                                        <form action="{{ route('bookmark', $article->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-link p-0">
        ...
        @else
            <p>No articles found based on the filters.</p>
        @endif
    </div>
@endsection
